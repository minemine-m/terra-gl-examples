...
watch(() => controls.duckScale, (val) => {
  if (duckModel) {
    // Model style update might need full object or specific setter
    // Usually setStyle merges
...
<template>
  <div class="relative w-full h-full">
    ...
    <div class="absolute top-4 right-4 bg-gray-800 p-4 rounded-lg shadow-lg z-10 w-64 border border-gray-700">
      <h3 class="text-white font-bold mb-4 border-b border-gray-600 pb-2">{{ t('examples.modelLayer.panelTitle') }}</h3>
      
      <!-- Duck Controls -->
      <div class="mb-6">
        <h4 class="text-yellow-400 font-bold text-sm mb-2">{{ t('examples.modelLayer.duckModel') }}</h4>
        <div class="mb-2">
          <label class="block text-gray-400 text-xs mb-1">{{ t('examples.modelLayer.scale') }}: {{ controls.duckScale }}</label>
        ...
        <div>
          <label class="block text-gray-400 text-xs mb-1">{{ t('examples.modelLayer.rotation') }}: {{ controls.duckRotation }}°</label>
      ...
      <!-- Cesium Man Controls -->
      <div>
        <h4 class="text-blue-400 font-bold text-sm mb-2">{{ t('examples.modelLayer.cesiumMan') }}</h4>
        <div class="mb-2">
          <label class="block text-gray-400 text-xs mb-1">{{ t('examples.modelLayer.scale') }}: {{ controls.manScale }}</label>
        ...
        <div>
          <label class="block text-gray-400 text-xs mb-1">{{ t('examples.modelLayer.rotation') }}: {{ controls.manRotation }}°</label>
